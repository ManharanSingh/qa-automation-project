...
class CheckoutPage(BasePage):
    ...
    def fill_details(self, name, last_name, zip_code):
            self.checkout_type(self.first_name_locator, name)
            self.checkout_type(self.last_name_locator, last_name)
            self.checkout_type(self.postal_code_locator, zip_code)
